...
import { Trophy, Users, Lock, Unlock } from 'lucide-react';
...
const LeagueCard: React.FC<LeagueCardProps> = ({ 
  ...
  const { id, name, private: isPrivate, shared_link } = league;
  
  // Avatar for the league
    ...
    <Card hover className="h-full">
      <CardHeader className="flex items-center gap-4 bg-accent-950">
        ...
        <div className="flex-1">
          <h3 className="font-racing font-bold text-lg truncate">{name}</h3>
